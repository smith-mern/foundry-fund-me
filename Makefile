...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --private-key $(METAMASK_PRIVATE_KEY) --broadcast --etherscan-api-key $(ETHERSCAN-API-KEY) --verify -vvvv
